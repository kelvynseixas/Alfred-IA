...
export const FinancialModule: React.FC<FinancialModuleProps> = ({ transactions, onAddTransaction, onEditTransaction, onDeleteTransaction, isDarkMode }) => {
  ...
  const axisColor = isDarkMode ? '#ffffff' : '#334155';
    ...
    <div className="space-y-6 animate-fade-in relative pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
           ...
           <div className={`p-4 rounded-xl border md:col-span-4 lg:col-span-2 ${cardBg}`}>
                <h3 className={`text-xs font-bold uppercase mb-4 ${textPrimary}`}>Comparativo Geral</h3>
                <div className="h-64">
                    <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={overviewChartData} layout="vertical">
                            <CartesianGrid strokeDasharray="3 3" stroke="#334155" horizontal={false} />
                            <XAxis type="number" stroke={axisColor} tick={{fill: axisColor}} tickFormatter={(val) => `R$${val/1000}k`} />
                            <YAxis dataKey="name" type="category" stroke={axisColor} tick={{fill: axisColor, fontSize: 12}} width={80} />
                            <Tooltip 
           ...
           <div className="md:col-span-4 lg:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className={`p-3 rounded-xl border flex flex-col items-center ${cardBg}`}>
                     <h3 className={`text-[10px] font-bold uppercase mb-2 ${textPrimary}`}>Categorias (Entrada)</h3>
                ...
                {/* Expense Pie */}
                <div className={`p-3 rounded-xl border flex flex-col items-center ${cardBg}`}>
                     <h3 className={`text-[10px] font-bold uppercase mb-2 ${textPrimary}`}>Categorias (Saída)</h3>
                     <div className="w-full h-40">
                         <ResponsiveContainer width="100%" height="100%">
                             <PieChart>
                ...
                {/* Invest Pie */}
                <div className={`p-3 rounded-xl border flex flex-col items-center ${cardBg}`}>
                     <h3 className={`text-[10px] font-bold uppercase mb-2 ${textPrimary}`}>Categorias (Invest.)</h3>
                     <div className="w-full h-40">
                         <ResponsiveContainer width="100%" height="100%">
                             <PieChart>
